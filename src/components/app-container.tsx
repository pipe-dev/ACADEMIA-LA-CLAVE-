  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-background text-foreground p-4 sm:p-8">
      <div className="text-center mb-8 sm:mb-12">
        <h1 className="text-3xl sm:text-5xl font-bold text-foreground">Bienvenido a Vocal Studio</h1>
        <p className="text-muted-foreground mt-3 max-w-xl text-md sm:text-lg">Para comenzar, ayúdanos a entender tu voz para personalizar tu experiencia.</p>
      </div>

      <div className="flex flex-col gap-6 sm:gap-8 w-full max-w-md animate-in fade-in-50 duration-500">
        <Card className="bg-card/50 border-2 border-transparent">
          ...
          <CardContent className="grid grid-cols-2 gap-3 sm:gap-4">
            <Button onClick={() => setPitchPreference('grave')} variant={pitchPreference === 'grave' ? 'default' : 'secondary'} size="lg" className="h-14 sm:h-16 text-sm sm:text-base">Cómodo en graves</Button>
            <Button onClick={() => setPitchPreference('agudo')} variant={pitchPreference === 'agudo' ? 'default' : 'secondary'} size="lg" className="h-14 sm:h-16 text-sm sm:text-base">Cómodo en agudos</Button>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card/50 border-2 border-transparent">
          ...
          <CardContent className="grid grid-cols-2 gap-3 sm:gap-4">
            <Button onClick={() => setGender('masculino')} variant={gender === 'masculino' ? 'default' : 'secondary'} size="lg" className="h-14 sm:h-16 text-sm sm:text-base">Masculina</Button>
            <Button onClick={() => setGender('femenino')} variant={gender === 'femenino' ? 'default' : 'secondary'} size="lg" className="h-14 sm:h-16 text-sm sm:text-base">Femenina</Button>
          </CardContent>
        </Card>
      </div>
    </main>
